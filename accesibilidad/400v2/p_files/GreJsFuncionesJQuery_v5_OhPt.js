...
$(function() 
{
	...
	{			 
        ...
        console.log('OKI Formulario enviado:', this);

        // Opcionalmente, puedes enviar el formulario programáticamente
		//sanitizar();
    });*/
});
...
function estaIdentificadoElectronicamente(datosCenso) 
{			
	if(datosCenso == true) 
		return "S"; //Estamos en version Admin y por tanto esta identificado el usuario sin necesidad de usar identificacion electronica (certificado etc)
	...
	$.ajax(
	{
		...
		{			
			...
			if(vResponse == "N") 				
				identificado = "N";	//No se ha identificado electronicamente								
			else
				identificado = "S"; //Se ha identificado electronicamente					
		}				
	});
